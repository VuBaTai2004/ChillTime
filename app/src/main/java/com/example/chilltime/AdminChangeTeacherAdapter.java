...
public class AdminChangeTeacherAdapter extends RecyclerView.Adapter<AdminChangeTeacherAdapter.ViewHolder> {
    ...
    public AdminChangeTeacherAdapter(List<TeacherProfile> teacherList) {
