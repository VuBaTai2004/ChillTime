...
public class AdminDeleteStudentFromClassAdapter extends RecyclerView.Adapter<AdminDeleteStudentFromClassAdapter.ViewHolder> {
    private final List<StudentProfile> studentList;
    private final List<StudentProfile> selectedStudents;

    public AdminDeleteStudentFromClassAdapter(List<StudentProfile> studentList) {
